...
class Instructions():
    ...
    def get_instructions(self, opt):
        self.instructions = {"01": """Sua função é agir como um tutor de ensino de Neurosciencia, 
                             ...
                             a qualquerpergunta que lhe seja feita de maneira direta e explicativa""",
                             "02": """Sua função é criar uma lista de exercícios a partir da solicitação 
                             do aluno, haja como tutor dele e proveja essas listas sem dar as respostas de
